CREATE TABLE IF NOT EXISTS AIRLINE_MANAGED_BY (
                            ID INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS AIRLINE_OPERATED_BY (
                                    ID INT NOT NULL,
                                    IATA VARCHAR2(255)  NOT NULL,
                                    DESCRIPTION VARCHAR2(255)  NOT NULL,
                                    CREATE_DATE TIMESTAMP WITH TIME ZONE,
...
CREATE SEQUENCE IF NOT EXISTS AIRLINE_OPERATED_BY_SEQ START WITH 1;
