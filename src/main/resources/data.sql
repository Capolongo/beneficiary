...
ALTER TABLE AIRLINE_MANAGED_BY ADD CONSTRAINT PK_AIRLINE_MANAGED_BY_ID PRIMARY KEY (ID);
...
ALTER TABLE AIRLINE_OPERATED_BY ADD CONSTRAINT PK_AIRLINE_OPERATED_BY_ID PRIMARY KEY (ID);
COMMENT ON COLUMN AIRLINE_MANAGED_BY.IATA is 'IATA DA COMPANHIA AEREA';
COMMENT ON COLUMN AIRLINE_MANAGED_BY.DESCRIPTION is 'DESCRIÇÃO DA COMPANHIA AEREA';
...
ALTER TABLE AIRLINE ADD CONSTRAINT PK_AIRLINE_ID PRIMARY KEY (ID);
CREATE INDEX AIRLINE_MANAGED_BY_ID_INDEX on AIRLINE(AIRLINE_MANAGED_BY_ID);
CREATE INDEX AIRLINE_OPERATED_BY_ID_INDEX on AIRLINE(AIRLINE_OPERATED_BY_ID);
...
ALTER TABLE FLIGHT_LEG ADD COLUMN AIRLINE_ID INT NOT NULL;
CREATE INDEX FLIGHT_LEG_AIRLINE_ID_INDEX on FLIGHT_LEG(AIRLINE_ID);
