...
public enum OrderFlightErrorType {
    ...
    ORDER_FLIGHT_PARTNER_RESERVATION_EXPIRED_BUSINESS_ERROR(BUSINESS, "OFCART404", "Erro ao adicionar pedido ao carrinho", "Favor tente novamente", HttpStatus.BAD_REQUEST, Level.WARN),
