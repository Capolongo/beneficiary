...
class GetCompletedListenerTest {
  ...
  @InjectMocks
  private GetCompletedListener listener;
  ...
  void shouldProcessSuccessOrder() throws JsonProcessingException {
    ...
    verify(completedService, times(1)).orderProcess(any());
    verifyNoMoreInteractions(completedService);
  }
  ...
  void shouldThrowAmqpRejectAndDontRequeueExceptionWhenMessageIsBroken()
    ...
    verifyNoInteractions(completedService);
  }
}
